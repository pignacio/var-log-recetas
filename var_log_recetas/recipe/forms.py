...
from var_log_recetas.ingredient.models import Ingredient, MeasureUnit
...
class MeasuredIngredientForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["amount"].widget.attrs.update(
            {"placeholder": "Amount", "min": 0.001, "step": "any"}
        )
        ...
        self.fields["unit"].queryset = MeasureUnit.objects.filter(
    ...
    def clean(self):
        ...
        if ingredient and unit and not ingredient.has_unit(unit):
...
class StepForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            "text": forms.Textarea(
                attrs={"rows": 3, "cols": 140, "style": "resize: none;"}
            )
        }
